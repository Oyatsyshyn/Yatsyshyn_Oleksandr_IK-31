...
```text
oleksandryatsyshyn ~/TPIS/Yatsyshyn_Oleksandr_IK-31/Lab_2 (master) $ pipenv -h
...
oleksandryatsyshyn ~/TPIS/Yatsyshyn_Oleksandr_IK-31/Lab_2 (master) $ 
```
...
Результат виконання:
```text
(Lab_2) root@oleksandryatsyshyn-vbox:/home/oleksandryatsyshyn/TPIS/Yatsyshyn_Oleksandr_IK-31/Lab_2# python app.py
========================================
...
Date is:  10-28-2021
success
(Lab_2) root@oleksandryatsyshyn-vbox:/home/oleksandryatsyshyn/TPIS/Yatsyshyn_Oleksandr_IK-31/Lab_2# 
```
...
Виконанння програми:
```text
(Lab_2) root@oleksandryatsyshyn-vbox:/home/oleksandryatsyshyn/TPIS/Yatsyshyn_Oleksandr_IK-31/Lab_2# pytest tests/tests.py
============================= test session starts ==============================
platform linux -- Python 3.8.10, pytest-6.2.5, py-1.10.0, pluggy-1.0.0
rootdir: /home/oleksandryatsyshyn/TPIS/Yatsyshyn_Oleksandr_IK-31/Lab_2
collected 5 items                                                              
...
```text
oleksandryatsyshyn ~/TPIS/Yatsyshyn_Oleksandr_IK-31/Lab_2 (master) $ make all
...
Pipfile: /home/oleksandryatsyshyn/TPIS/Yatsyshyn_Oleksandr_IK-31/Lab_2/Pipfile
...
To github.com:oleksandryatsyshyn/Yatsyshyn_Oleksandr_IK-31.git
